...
// Getting preprocessed data from location in drive

! gdown  https://drive.google.com/uc?id=1-2H6NLY5L_2bJeDJFmh1OnNEvUnZWiGx

df = pd.read_csv('final_he_conv.csv')
df = df.dropna()
trn_df, val_df = train_test_split(df, test_size = 0.2)

// To display first few elements in train dataframe

trn_df.head()

// Also check the size of the sets
...
// Tokenizer for encoding dataset
...
// Applying model to train and validation set
main(trn_df, val_df)
